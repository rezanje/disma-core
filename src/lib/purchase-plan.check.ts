...
assert.equal(lineIsPlanned({ id: 'a', purchaseMethod: 'Pasar', paymentMethod: 'Cash' }), true,
...
assert.equal(lineIsPlanned({ id: 'd', purchaseMethod: 'Dropship', paymentMethod: 'Cash' }), false);
...
const LINES = [
  { id: 'a', purchaseMethod: 'Pasar', paymentMethod: 'Cash' },
