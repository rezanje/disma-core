...
export type AccessKey = 
  ...
  | 'finance_budget' | 'finance_cash_bank' | 'finance_expenses' | 'finance_ledger' | 'finance_invoices'
...
export interface OperationalExpense {
  ...
  date: string;
  reporterId: string;
  purchaseId?: string; // Links this expense to a specific sourcing budget drop
...
export interface Reimbursement {
  ...
  date: string;
  userId: string;
  purchaseId?: string; // Links this reimbursement to a specific sourcing budget drop
  title: string;
  amount: number;
  description: string;
  receiptUrl?: string;
