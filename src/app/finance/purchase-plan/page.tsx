...
export default function PurchasePlanPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Pencairan tidak lagi di layar ini (23 Agu 2026). Uang keluar cuma punya
          satu pintu — menu Disbursement — supaya tidak ada dua tempat memindahkan
          uang yang sama. Dokumen belanjanya tetap ikut tercatat: pencairan menunjuk
          dokumen mana yang didanai, dan dokumennya dicap begitu transfernya jalan. */}
